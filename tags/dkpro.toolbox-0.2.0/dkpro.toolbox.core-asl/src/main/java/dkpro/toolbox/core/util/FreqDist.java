 ...
 * </pre></blockquote>
 * 
 * The last call to {@link FreqDist#getCount} will yield 2, because the
    ...
    implements Serializable
{
    ...
    /**
     * Creates a new empty {@link FreqDist}.
     */
    public FreqDist()
    {
    ...
    /**
     * Creates a new {@link FreqDist} prefilled with samples from an {@link Iterable}.
     * The count for each sample in the iterable is cumulatively increased by 1.
     * 
     * @param iterable
     *            the {@link Iterable} used to fill the {@link FreqDist}
     */
