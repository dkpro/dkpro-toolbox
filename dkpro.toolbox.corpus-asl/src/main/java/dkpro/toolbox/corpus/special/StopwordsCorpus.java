    ...
    implements Corpus
{
    ...
    private StopwordsLanguage language;
    private List<String> tokens;
    
    public StopwordsCorpus(StopwordsLanguage language)
            throws CorpusException
    {
        this.language = language;
        
        String file = "classpath:/corpus/stopwords/" + language.name() + ".txt.gz";
        try {
    ...
    {
        return "stopwords lists of several languages";
    }
}